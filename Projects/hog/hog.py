...
def take_turn(num_rolls, opponent_score, dice=six_sided, goal=GOAL_SCORE):
    ...
    if not num_rolls: # numrolls = 0, which is falsy
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while max(score0, score1) < goal:
        if who == 0:
            score0 += take_turn(strategy0(score0, score1), score1, dice, goal) # player 0
            score0 += hog_pile(score0, score1)
        else:
            score1 += take_turn(strategy1(score1, score0), score0, dice, goal) # player 1
...
def make_averaged(original_function, trials_count=1000):
    ...
    def averaged_function(*args):
        ...
        return sum / trials_count # Returns average
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    max, max_num_rolls = 0, 0
    averaged_dice = make_averaged(roll_dice, trials_count)
    for num_rolls in range(1, 11):
        current_score = averaged_dice(num_rolls, dice)
