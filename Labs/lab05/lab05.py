...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    distance_a = distance(make_city("test city", lat, lon), city_a)
    distance_b = distance(make_city("test city", lat, lon), city_b)

    return get_name(city_b) if distance_b <= distance_a else get_name(city_a)
...
def berry_finder(t):
    ...
    if is_leaf(t):
        ...
        for b in branches(t):
            result = berry_finder(b) or result
    return result
